...
class LTDBACS_trts_7016(models.Model):
   ...
   stddevsp9800a17 = models.DecimalField(max_digits=10,decimal_places=2,null=True)
   ...
   stddevsp0709a17 = models.DecimalField(max_digits=10,decimal_places=2,null=True)
   ...
   stddevsp1517a17 = models.DecimalField(max_digits=10,decimal_places=2,null=True)
